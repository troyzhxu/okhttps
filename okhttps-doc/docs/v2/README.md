...
项目 | 最新版本 | 描述
-|-|-
[okhttps](https://gitee.com/ejlchina-zhxu/okhttps) | 2.5.0 | OkHttps 核心模块
...
[okhttps-stomp](https://gitee.com/ejlchina-zhxu/okhttps/tree/dev/okhttps-stomp) | 2.5.0 | 超轻量 Stomp 客户端（无第三方依赖）
[okhttps-xml](https://gitee.com/ejlchina-zhxu/okhttps/tree/dev/okhttps-xml) | 2.5.0 | 超轻量 XML 解析扩展（无第三方依赖，但仅支持 Java 8）
